...
const ClaimConditionInputSchema = zod.z.object({
  ...
  maxQuantity: QueryParams.QuantitySchema,
  quantityLimitPerTransaction: QueryParams.QuantitySchema,
...
class ShardedMerkleTree {
  ...
  static hashEntry(entry, tokenDecimals) {
    return hashLeafNode(entry.address, ethers.utils.parseUnits(entry.maxClaimable, tokenDecimals));
  }
  ...
  static async buildAndUpload(snapshotInput, tokenDecimals, storage) {
    ...
    const roots = Object.fromEntries(Object.entries(shards).map(_ref => {
      ...
      return [shard, new merkletreejs.MerkleTree(entries.map(entry => ShardedMerkleTree.hashEntry(entry, tokenDecimals)), ethers.utils.keccak256, {
        sort: true
      }).getHexRoot()];
  ...
  async getProof(address) {
    ...
    if (shard === undefined) {
      try {
        ...
        this.trees[shardId] = new merkletreejs.MerkleTree(shard.entries.map(entry => ShardedMerkleTree.hashEntry(entry, this.tokenDecimals)), ethers.utils.keccak256, {
          sort: true
        });
      } catch (e) {
...
function extractIPFSHashFromBytecode(bytecode) {
  ...
  const cborData = cborX.decode(bytecodeBuffer);
...
async function prepareClaim(quantity, activeClaimCondition, merkleMetadataFetcher, tokenDecimals, contractWrapper, storage, checkERC20Allowance) {
  ...
  try {
    if (!activeClaimCondition.merkleRootHash.toString().startsWith(ethers.constants.AddressZero)) {
      ...
      proofs = claim.proof;
      maxClaimable = ethers.ethers.utils.parseUnits(claim.maxClaimable, tokenDecimals);
    }
  } catch (e) {
...
class Erc721ClaimableWithConditions {
  ...
  constructor(erc721, contractWrapper, storage) {
    QueryParams._defineProperty(this, "featureName", FEATURE_NFT_CLAIMABLE_WITH_CONDITIONS.name);
...
const EditionDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [abi, contract, _network] = await Promise.all([EditionDropInitializer.getAbi(), Promise.resolve().then(function () { return require('./edition-drop-6ac0132f.cjs.prod.js'); }), provider.getNetwork()]);
...
const EditionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([EditionInitializer.getAbi(), Promise.resolve().then(function () { return require('./edition-fb050993.cjs.prod.js'); }), provider.getNetwork()]);
...
const MarketplaceInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MarketplaceInitializer.getAbi(), Promise.resolve().then(function () { return require('./marketplace-8bffd9d1.cjs.prod.js'); }), provider.getNetwork()]);
...
const MultiwrapInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([MultiwrapInitializer.getAbi(), Promise.resolve().then(function () { return require('./multiwrap-08dab8c0.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTCollectionInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTCollectionInitializer.getAbi(), Promise.resolve().then(function () { return require('./nft-collection-0106ab72.cjs.prod.js'); }), provider.getNetwork()]);
...
const NFTDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([NFTDropInitializer.getAbi(), Promise.resolve().then(function () { return require('./nft-drop-c4d9e0b2.cjs.prod.js'); }), provider.getNetwork()]);
...
const PackInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([PackInitializer.getAbi(), Promise.resolve().then(function () { return require('./pack-aaa41a7e.cjs.prod.js'); }), provider.getNetwork()]);
...
const SignatureDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SignatureDropInitializer.getAbi(), Promise.resolve().then(function () { return require('./signature-drop-30ee0986.cjs.prod.js'); }), provider.getNetwork()]);
...
const SplitInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([SplitInitializer.getAbi(), Promise.resolve().then(function () { return require('./split-5f268ff7.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenDropInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenDropInitializer.getAbi(), Promise.resolve().then(function () { return require('./token-drop-014c0d64.cjs.prod.js'); }), provider.getNetwork()]);
...
const TokenInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([TokenInitializer.getAbi(), Promise.resolve().then(function () { return require('./token-906dcdff.cjs.prod.js'); }), provider.getNetwork()]);
...
const VoteInitializer = {
  ...
  initialize: async function () {
    ...
    const [, provider] = getSignerAndProvider(network, options);
    const [abi, contract, _network] = await Promise.all([VoteInitializer.getAbi(), Promise.resolve().then(function () { return require('./vote-eb478555.cjs.prod.js'); }), provider.getNetwork()]);
